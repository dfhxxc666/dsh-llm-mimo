 ...
 * MiMo (OpenAI-compatible) protocol: the literal `[DONE]` is yielded so the
 * caller owns final flushing, and EOF before it raises {@link LlmError}.
 ...
 * payload.
 *
 * @module dsh-llm-mimo/sse
 */

import { EventSourceParserStream } from 'eventsource-parser/stream'
import { LlmError } from '@deepseek-ai/dsh-llm'

/** The terminal payload MiMo (and OpenAI) send after the last chunk. */
