 ...
 *
 * MiMo uses the same `reasoning_content` field as DeepSeek for thinking chains.
 * The translation logic is nearly identical to dsh-llm-deepseek/translate.
 *
 * @module dsh-llm-mimo/translate
 */
...
/**
 * Map wire usage fields. MiMo's `prompt_tokens` may include cache hits;
 * we subtract them to keep the harness convention of disjoint counts.
 ...
 *
 * MiMo's thinking chain uses `reasoning_content` field, same as DeepSeek.
 * The empty-string first chunk must not open a reasoning block.
 *
